...
WITH MinLogDate AS (
    ...
    WHERE ZP2.FK_STATUS_PROPOSTA = '102'
    GROUP BY ZP2.ID
)
SELECT
    ...
    END AS 'DIFERENCA',
    MC.TEXTO_MOTIVO AS 'MOTIVO CANCELAMENTO',
    MCP.DESCRICAO_CANCELAMENTO AS 'DESCRIÇÃO CANCELAMENTO'
...
WHERE P.FK_STATUS_PROPOSTA = '102'
