...
AND (OP.FK_STATUS_OPORTUNIDADE NOT IN ('104') OR OP.FK_STATUS_OPORTUNIDADE IS NULL) -- Adicionando o filtro aqui
...
AND (TOP.FK_STATUS_OPORTUNIDADE NOT IN ('104') OR TOP.FK_STATUS_OPORTUNIDADE IS NULL) -- Adicionando o filtro aqui
AND C.CONTROLADORIA_ESHOWS = 1
AND C.ACTIVE = 1
