...
def show_monitoring_today_and_tomorrow():
    ...
    CAST(CIN.HORARIO_CHECKIN AS TIME) AS 'HORÁRIO CHECKIN',
...
def hole_map():
    ...
    *
    ...
    PA.NOME AS PALCO,
    TF.DESCRICAO AS 'FORMAÇÃO',
    OP.ID as "ID OPORTUNIDADE",
    P.CONTA as 'OBSERVAÇÃO',
    CASE 
    ...
    GROUP BY ESTABELECIMENTO, 'HORÁRIO', 'DATA INÍCIO'
    ORDER BY 'DATA INÍCIO', 'HORÁRIO'
    """)
